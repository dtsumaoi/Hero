...
class MobileNumberStep extends Step<String> {
    ...
    protected View createStepContentLayout() {
        ...
        mobileNumberView = new EditText(getContext());
        mobileNumberView.setSingleLine(true);
        mobileNumberView.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_CLASS_PHONE);
    ...
    protected IsDataValid isStepDataValid(String stepData) {
        ...
        String errorMessage = !isNumberValid ? "Provide complete mobile number without the leading zero" : "";
    ...
    public String getStepData() {
        ...
        Editable number = mobileNumberView.getText();
    ...
    public void restoreStepData(String stepData) {
        ...
        mobileNumberView.setText(stepData);
    }
}
